...
export const characters: Character[] = [
  {
    ...
    portrait: {
      ...
      alt: "S.E.N.I.L.E personnel card asset 1",
      width: 1080,
      height: 1600,
    },
  },
  {
    ...
    portrait: {
      ...
      alt: "S.E.N.I.L.E personnel card asset 2",
      width: 1080,
      height: 1600,
    },
  },
  {
    ...
    portrait: {
      ...
      alt: "S.E.N.I.L.E personnel card asset 3",
      width: 1080,
      height: 1600,
    },
  },
  {
    ...
    portrait: {
      src: "/images/agents/4.webp",
      alt: "S.E.N.I.L.E personnel card asset 4",
      width: 1080,
      height: 1600,
    },
  },
  {
    ...
    portrait: {
      src: "/images/agents/5.webp",
      alt: "S.E.N.I.L.E personnel card asset 5",
      width: 1080,
      height: 1600,
    },
  },
  {
    ...
    portrait: {
      src: "/images/agents/6.webp",
      alt: "S.E.N.I.L.E personnel card asset 6",
      width: 1080,
      height: 1600,
    },
  },
  {
    id: "agent-harrow",
    name: "Agent Harrow",
    codename: "Undercover Field Operative",
    clearanceLevel: "Clearance C",
    psychologicalNotes: "Maintains deep-cover deployment posture under prolonged operational strain.",
    knownAssignments: ["Case 008", "Classified Assignment"],
    visibility: "PARTIALLY_REDACTED",
    redactedNotes: ["Undercover operation remains active ███", "No further personal details known ███"],
    portrait: {
      src: "/images/agents/7.webp",
      alt: "S.E.N.I.L.E personnel card for Agent Harrow",
      width: 1080,
      height: 1600,
    },
  },
  {
    id: "agent-ohm",
    name: "Agent Ohm",
    codename: "Signals and Systems Operative",
    clearanceLevel: "Clearance B",
    psychologicalNotes: "Tracks low-level system anomalies across overlapping communication channels.",
    knownAssignments: ["Case 009", "Classified Assignment"],
    visibility: "PARTIALLY_REDACTED",
    redactedNotes: ["Assignment timeline unavailable under Protocol 7 ███", "No further details known ███"],
    portrait: {
      src: "/images/agents/8.webp",
      alt: "S.E.N.I.L.E personnel card for Agent Ohm",
      width: 1080,
      height: 1600,
    },
  },
  {
    ...
    visibility: "PARTIALLY_REDACTED",
    redactedNotes: ["Operational notes withheld pending director review ███"],
    portrait: {
      src: "/images/agents/9.webp",
      alt: "S.E.N.I.L.E personnel card for Agent MT",
      width: 1080,
      height: 1600,
    },
  },
  ...
  },
  {
    ...
    redactedNotes: [
      "Operational notes withheld pending director review ███",
      "Undercover status active. No further details known ███",
    ],
  },
  {
    id: "agent-file-12",
    name: "Agent File 12",
    codename: "Archive Liaison",
    clearanceLevel: "Clearance D",
    psychologicalNotes: "Dossier pending full transcription from updated archive card.",
    knownAssignments: ["Case 010"],
    visibility: "PARTIALLY_REDACTED",
    redactedNotes: [
      "Operational notes withheld pending director review ███",
      "Agent uncover tag unresolved. No further details known ███",
    ],
  },
];
